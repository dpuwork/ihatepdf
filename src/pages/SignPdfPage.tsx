...
export default function SignPdfPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 font-mono text-ink">
      {/* Header */}
      <FeatureHeader title={"Sign PDF"} descripiton={"Draw your signature and place it on your document."} />
          ...
          <div className="p-6 bg-gray-50 border-4 border-gray-200 rounded-lg">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-1 text-sm font-bold uppercase tracking-wide border-2 border-gray-300 rounded hover:bg-gray-100 transition-colors"
              >
            ...
            <canvas
              ...
              width={400}
              height={120}
              className="w-full max-w-md border-4 border-black rounded-lg cursor-crosshair mx-auto block"
