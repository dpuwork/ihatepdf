...
import { downloadBlob, imagesToPdf, PAGE_SIZES, type PageSizeKey } from "../lib/pdf-images";
...
export default function JpgToPdfPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 font-mono text-ink">
      {/* Header */}
      <FeatureHeader title={"JPG to PDF"} descripiton={"Convert your images to a PDF document."} />
            ...
            <>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6 pt-6 border-t-2 border-gray-200">
                <div className="flex items-center gap-3">
                  <label className="font-bold text-sm uppercase tracking-wide text-gray-600">
                    Page Size:
                  </label>
                  <select
                    value={pageSize}
